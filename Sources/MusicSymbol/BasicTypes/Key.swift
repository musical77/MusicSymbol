...
/// Base pitch of the key without accidentals. Accidentals will take account in the parent struct,
/// `Key`. Integer values are based on C = 0 on western chromatic scale.
